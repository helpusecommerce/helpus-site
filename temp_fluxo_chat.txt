// 📁 src/fluxo/fluxoChat.js
const fluxo = {
  // Passo inicial com coleta de nome/email
  nomeEmail: {
  ...
  // Saudações iniciais
  inicio: {
    mensagem: "👋 Olá! Eu sou a Hel, atendente virtual da HelpUS. Em qual desses assuntos você gostaria de ajuda hoje?",
    opcoes: [
  ...
  // Vistos
  vistos1: {
    mensagem: "Oferecemos suporte completo para diferentes tipos de visto:",
    opcoes: [
      { texto: "✈️ Turismo (B1/B2)", proximo: "vistos_b1b2" },
  ...
  // Empresa
  empresa1: {
    mensagem: "Você deseja abrir uma empresa nos EUA? Temos as seguintes opções:",
    opcoes: [
